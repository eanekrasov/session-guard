...
describe('sidebar mount', () => {
  it('renders rules without crashing on Solid conditions', async () => {
    ...
    try {
      ...
      if (savedOpencode !== undefined) process.env.OPENCODE_CONFIG_DIR = savedOpencode;
