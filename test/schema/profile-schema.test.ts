...
describe('ProfileSchemaSchema', () => {
  ...
  describe('transitions', () => {
    it('accepts transitions with guard, from, to fields', () => {
      const input = {
        transitions: [
          {
            from: 'PLANNING',
    ...
    it('accepts transition without an optional guard', () => {
      const input = {
  ...
  describe('editingAgents', () => {
    it('accepts editingAgents as a string array', () => {
      const input = {
        editingAgents: ['code'],
      };
