---
description: Reviews a workflow task for the host smoke run
mode: subagent
---
...
`<workflow-result>{"gate":"review","status":"pass","summary":"<what you checked>","evidence":["<file:line or check>"]}</workflow-result>`
